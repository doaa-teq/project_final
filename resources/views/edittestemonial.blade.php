									...
									<form action="{{ route('updatetestimonial',$testimonial->id) }}" method="post">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="name" required="required" class="form-control" name="title" value="{{ $testimonial -> title }}">
											</div>
										</div>
                                        <div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="image" name="image" required="required" class="form-control" value="{{ $testimonial -> image }}">
												<img src="{{asset('assetss/images/'.$testimonial->image)}}" alt="" style="width: 300px;">
											</div>
										</div>
