									...
									<form action="{{route('test')}}" method="post" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="name" required="required" class="form-control" name="title" value="{{old('title')}}">
												@error('title')
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="published" value="{{old('published')}}">
													@error('published')
												 	<div class="alert alert-warning">{{ $message }}</div>
                                                	@enderror	
												</label>
