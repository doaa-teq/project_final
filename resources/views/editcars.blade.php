                                     ...
                                     @method('put')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<img src="{{asset('assetss/images/'.$car->image)}}" alt="" style="width: 300px;">
											</div>
										</div>
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="category" id="">
													...
													@foreach($categories as $category)
														<option value="{{$category->id}}"@selected( $category->category_name == $car->category->category_name)>{{$category->category_name}}</option>
                                                    @endforeach
												</select>
											</div>
										</div>
