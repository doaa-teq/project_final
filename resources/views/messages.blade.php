           ...
           <!-- sidebar menu -->
                ...
                <li><a><i class="fa fa-desktop"></i> Testimonials <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href='edittestimonial/{id}'>Edit Testimonials</a></li>
									</ul>
								</li>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><img src="{{asset('assetss/images/edit.png')}}" alt="Edit"></td>
                          <td><img src="{{asset('assetss/images/delete.png')}}" alt="Delete"></td>
                        </tr>
                        <tr>
                          <td>First Name and Last Name</td>
                          <td>mail@example.com</td>
