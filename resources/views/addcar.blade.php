					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{route('coon')}}" method="post" enctype="multipart/form-data">
									  @csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="content" required="required" class="form-control" value="{{old('content')}}"></textarea>
												@error('content')
												 <div class="alert alert-warning">{{ $message }}</div>
                                                 @enderror
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select name="category_id" id="">
													<option value="category1">select category1</option>
